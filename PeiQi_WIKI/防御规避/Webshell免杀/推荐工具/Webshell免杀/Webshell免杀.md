...
![](image/webshell-4.png)

> [!NOTE]
>
> WEBDIR+

![](image/webshell-5.png)



后续作者重新写入文件 **php_D_webshell.py** 用于专门绕过 **D盾**
...
![](image/webshell-6.png)

其他免杀使用方法类似，自行测试，目前可过大部分普通查杀安全设备